...
export default class PostFluid {
  constructor() {
    ...
    this.supportLinearFiltering = this.gl.renderer.instance.gl.renderer.extensions[`OES_texture_${this.gl.renderer.instance.gl.renderer.isWebgl2 ? `` : `half_`}float_linear`];
    this.halfFloat = this.gl.renderer.instance.gl.renderer.isWebgl2 ? this.gl.renderer.instance.gl.HALF_FLOAT : this.gl.renderer.instance.gl.renderer.extensions['OES_texture_half_float'].HALF_FLOAT_OES;

    this.filtering = this.supportLinearFiltering ? this.gl.renderer.instance.gl.LINEAR : this.gl.renderer.instance.gl.NEAREST;

    if (this.gl.renderer.instance.gl.renderer.isWebgl2) {
      this.rgba = this.getSupportedFormat(this.gl.renderer.instance.gl, this.gl.renderer.instance.gl.RGBA16F, this.gl.renderer.instance.gl.RGBA, this.halfFloat);
      this.rg = this.getSupportedFormat(this.gl.renderer.instance.gl, this.gl.renderer.instance.gl.RG16F, this.gl.renderer.instance.gl.RG, this.halfFloat);
      this.r = this.getSupportedFormat(this.gl.renderer.instance.gl, this.gl.renderer.instance.gl.R16F, this.gl.renderer.instance.gl.RED, this.halfFloat);
    } else {
      this.rgba = this.getSupportedFormat(this.gl.renderer.instance.gl, this.gl.renderer.instance.gl.RGBA, this.gl.renderer.instance.gl.RGBA, this.halfFloat);
      this.rg = rgba;
      this.r = rgba;
    }

    // Create fluid simulation FBOs
    this.density = this.createDoubleFBO(this.gl.renderer.instance.gl, {
      width: this.dyeRes,
      height: this.dyeRes,
      type: this.halfFloat,
    ...
    this.velocity = this.createDoubleFBO(this.gl.renderer.instance.gl, {
      width: this.simRes,
      height: this.simRes,
      type: this.halfFloat,
    ...
    this.pressure = this.createDoubleFBO(this.gl.renderer.instance.gl, {
      width: this.simRes,
      height: this.simRes,
      type: this.halfFloat,
      format: this.r?.format,
      internalFormat: this.r?.internalFormat,
      minFilter: this.gl.renderer.instance.gl.NEAREST,
      depth: false,
    });

    this.divergence = new RenderTarget(this.gl.renderer.instance.gl, {
      width: this.simRes,
      height: this.simRes,
      type: this.halfFloat,
      format: this.r?.format,
    ...
    this.curl = new RenderTarget(this.gl.renderer.instance.gl, {
      width: this.simRes,
      height: this.simRes,
      type: this.halfFloat,
      format: this.r?.format,
    ...
    this.triangle = new Geometry(this.gl.renderer.instance.gl, {
      position: { size: 2, data: new Float32Array([-1, -1, 3, -1, -1, 3]) },
      uv: { size: 2, data: new Float32Array([0, 0, 2, 0, 0, 2]) },
    });

    // Create fluid simulation programs
    this.clearProgram = new Mesh(this.gl.renderer.instance.gl, {
    ...
    this.splatProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
    ...
    this.advectionProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
        fragment: this.supportLinearFiltering ? this.advectionShader : this.advectionManualFilteringShader,
        uniforms: {
          texelSize: this.texelSize,
    ...
    this.divergenceProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
    ...
    this.curlProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
    ...
    this.vorticityProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
    ...
    this.pressureProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
    ...
    this.gradientSubtractProgram = new Mesh(this.gl.renderer.instance.gl, {
      geometry: this.triangle,
      program: new Program(this.gl.renderer.instance.gl, {
        vertex: this.baseVertex,
  ...
  updateMouse(e) {
    ...
    if (Math.abs(deltaX) || Math.abs(deltaY)) {
      this.splats.push({
        ...
        x: e.x / this.gl.renderer.instance.width,
        y: 1 - e.y / this.gl.renderer.instance.height,
        dx: deltaX * 5,
        dy: deltaY * -5,
      });
    }
  ...
  splat({ x, y, dx, dy }) {
    ...
    this.splatProgram.program.uniforms.aspectRatio.value = this.gl.renderer.instance.width / this.gl.renderer.instance.height;
  ...
  createDoubleFBO(gl, { width, height, wrapS, wrapT, minFilter = gl.LINEAR, magFilter = minFilter, type, format, internalFormat, depth } = {}) {
  ...
  update() {
    ...
    this.gl.renderer.instance.gl.renderer.autoClear = false;
    ...
    this.gl.renderer.instance.gl.renderer.render({
    ...
    this.gl.renderer.instance.gl.renderer.autoClear = true;
  }
}
